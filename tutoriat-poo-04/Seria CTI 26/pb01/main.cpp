...
int main() {
    auto *p1 = new Persoana("Popescu");
//    p1->printInfo();
    auto *a1 = new Angajat("Mircea", "Magazin Mixt SRL", 156345);
//    a1->printInfo();
    auto *s1 = new Student("Pascu", "UniBuc", "FMI");
//    s1->printInfo();
    auto *b1 = new Bugetar("Dan", "PMB", 890890, 3503.25);
//    b1->printInfo();
    auto *m1 = new Muncitor("Gica", "Gica SRL", 123456, 40, 150.23);
    auto *m2 = new Muncitor("Marcel", "Gica SRL", 123456, 40, 120.23);
    auto *m3 = new Muncitor("Vasile", "Gica SRL", 123456, 40, 130.23);
//    m1->printInfo();
    auto *sb1 = new StudentBursier("Laur", "UniBuc", "FMI", 760);
    auto *sb2 = new StudentBursier("Crina", "UniBuc", "FMI", 860);
//    sb1->printInfo();
...
//    }
    ...
    // afisare munctori si studenti bursieri, grupati
